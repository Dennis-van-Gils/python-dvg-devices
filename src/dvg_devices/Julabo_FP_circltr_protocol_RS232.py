#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""RS232 function library for Julabo FP## circulators.
...
"""
import serial
from dvg_devices import BaseDevice

dev = BaseDevice.SerialDevice()
dev.serial_settings["baudrate"]=4800
dev.serial_settings["bytesize"]=serial.SEVENBITS
dev.serial_settings["parity"]=serial.PARITY_EVEN
dev.set_write_termination("\r")
dev.set_read_termination("\r\n")

dev.connect_at_port("com6")

# For unknown reasons, the first query always times out
# Catch it here, silently
try:
	dev.query("", raises_on_timeout=True)
except:
	pass

dev.query("version")
 --> reply: "JULABO HIGHTECH FL HL/SL VERSION 4.0"
