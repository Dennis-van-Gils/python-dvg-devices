#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Provides base classes :class:`SerialDevice()` and
:class:`TelnetServerDevice()`, offering higher-level general I/O methods for
your devices. These base classes are meant to be inherited into your own
specific *Device* class.

Instances of these classes will tie in nicely with
...
__date__ = "13-05-2026"
__version__ = "1.6.0"
# pylint: disable=broad-except, too-many-instance-attributes, too-many-lines
...
class SerialDevice:
    ...
    by wrapping the
    `pySerial <https://pyserial.readthedocs.io/en/latest/pyserial.html>`_
    library.

    The following functionality is offered:

    * I/O methods: :meth:`readline()`, :meth:`write()`, :meth:`query()`,
      :meth:`query_ascii_values()`, :meth:`query_bytes()`.
