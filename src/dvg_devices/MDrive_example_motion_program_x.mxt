...
Vi = 25600        'Initial velocity
Vm = 256000       'Maximum velocity
A = 1024000       'Acceleration
D = 1024000       'Deceleration

'Look up from motor spec sheet
Rc = 25           'Motor run current
Hc = 5            'Motor holding current

'Specific to Python interface:
'https://github.com/Dennis-van-Gils/python-dvg-devices
VA CT = 0         'Movement type: 0 = linear, 1 = angular
VA C0 = 51200     'Steps per mm (linear) or steps per revolution (angular)

'Limit switches
VA L1 = 3         'Input type for switch S1, 0: no switch
VA L2 = 2         'Input type for switch S2, 0: no switch
S1 = L1, 1, 0
S2 = L2, 1, 0
S3 = 0, 1, 0
S4 = 0, 1, 0
...
LB F2             '--- Home
  ...
  S1 = 1, 1, 0    'Ensure S1 is set as homing switch
